...
def princess_lives_here(eat_it):
	...
	if eat_it == "eat it":
		...
		print "The princess looks at you confused and points at the cake."
...
def gold_koi_pond(feed_it):
	...
	if feed_it == "feed it":
		...
		print "TYou are then pooped out sometime later."
		return 'death'
		...
		print "then it *lunges* out of the water, up in the ar and over your"
